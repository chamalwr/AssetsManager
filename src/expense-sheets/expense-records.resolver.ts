...
export class ExpenseRecordResolver {
  ...
  createExpenseRecord(
    @Args('expenseSheetId') expenseSheetId: string,
    @Args('createExpenseRecordInput')
    createExpenseRecordInput: CreateExpenseRecordInput,
  ) {
    return this.expenseRecordService.create(
      expenseSheetId,
  ...
  updateExpenseRecord(
    ...
    @Args('updateExpenseRecordInput')
    updateExpenseRecordInput: UpdateExpenseRecordInput,
  ) {
    return this.expenseRecordService.update(
      expenseSheetId,
      id,
